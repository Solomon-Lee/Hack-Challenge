...
public class CustomSwitch: UIControl {
    ...
    @IBInspectable
    public var onTintColor: UIColor = UIColor(red: 1, green: 1, blue: 1, alpha: 1) {
        didSet {
            self.layoutSubviews()
        }
    }
    ...
    @IBInspectable
    public var offTintColor: UIColor = UIColor(red: 1, green: 1, blue: 1, alpha: 1) {
        didSet {
            self.layoutSubviews()
        }
    }
    ...
    @IBInspectable
    public var thumbOnTintColor: UIColor = UIColor(red: 0.12, green: 0.12, blue: 0.13, alpha: 1) {
        didSet {
            self.layoutSubviews()
        }
    }
    ...
    @IBInspectable
    public var thumbOffTintColor: UIColor = UIColor(red: 0.12, green: 0.12, blue: 0.13, alpha: 1) {
        didSet {
            self.layoutSubviews()
        }
    }
    ...
    public override func layoutSubviews() {
        ...
        if !self.isAnimating {
            ...
            let thumbSize = self.thumbSize != CGSize.zero ? self.thumbSize : CGSize(width: (self.bounds.size.width / 2)+5, height: self.bounds.height * 1.714)
